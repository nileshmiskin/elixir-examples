defmodule SublistTest do
  ...
  test "huge sublist not in huge list" do
    assert Sublist.compare(Enum.to_list(10..1_001), Enum.to_list(1..1_000)) == :unequal
  end
  ...
  test "option 2 first list missing additional digits from second list" do
    assert Sublist.compare([12, 2, 23], [1, 22, 23]) == :unequal
  end

  test "option 3 first list missing additional digits from second list" do
    assert Sublist.compare([2, 22, 222], [22, 2, 222]) == :unequal
  end
